...
| 18.04.2025 | 4.5        | - Launched the application using Docker (Ver2)<br>- Performed a new ZAP scan<br>- Updated the test report and logbook | - Application accessible at http://localhost:8000/register<br>- ZAP report: 1 Medium-risk finding (missing CSRF protection)<br>- Updated test report and logbook in GitHub repository | - Initial confusion regarding the location of Ver2<br>- Needed clarification that Ver2 should be launched directly from the Phase 1 folder | - Check if CSRF protection is added in the next version<br>- Proceed to the next testing phase |
